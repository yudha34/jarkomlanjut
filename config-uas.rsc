# jan/26/2024 02:39:05 by RouterOS 6.48.7
...
/interface vlan
add interface=bridge1 name=vlanrouter vlan-id=25
...
set 5 default-vlan-id=25 vlan-header=always-strip vlan-mode=secure
...
add bridge=bridge1 tagged=ether1,bridge1 vlan-ids=25
